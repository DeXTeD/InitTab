...
angular.module('App', ['ngRoute', 'angular-sortable-view']).factory('userData', function() {
  ...
  '$http', 'userData', '$q', function($http, userData, $q) {
    ...
    url = function(action) {
      ...
      return 'db.php?user=' + userData.key + action;
    };
    cache = null;
    return {
      get: function() {
      ...
      create: function(block) {
        return $http.post(url('create'), block).success(function(data, status, headers, config) {
          return cache = data;
        });
      },
      remove: function(block) {
        return $http.post(url('remove'), block).success(function(data, status, headers, config) {
          return cache = data;
        });
      },
      edit: function(block) {
        return $http.post(url('edit'), block).success(function(data, status, headers, config) {
          return cache = data;
        });
      }
    };
  ...
  return function(items, query) {
    ...
    return _(items).sortBy(function(item) {
  ...
  '$scope', '$http', '$location', 'gridData', function($scope, $http, $location, gridData) {
    $scope.block = {};
    return $scope.save = function() {
      return gridData.create($scope.block).success(function() {
        return $location.url('/');
      });
    };
  }
  ...
  '$scope', '$http', '$routeParams', '$location', 'gridData', function($scope, $http, $routeParams, $location, gridData) {
    ...
    return $scope.save = function() {
      return gridData.edit($scope.block).success(function() {
        return $location.url('/');
      });
    };
  }
  ...
  '$scope', '$http', '$routeParams', '$location', 'gridData', function($scope, $http, $routeParams, $location, gridData) {
    ...
    return $scope.remove = function() {
      return gridData.remove($scope.block).success(function() {
        return $location.url('/');
      });
    };
  }
